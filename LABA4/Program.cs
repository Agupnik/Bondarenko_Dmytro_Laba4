...
namespace LABA4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] names = new string[] { "Антипенко Богдан", "Богайчук Юрий", "Бойко Элизавета", "Василенко Александр", "Волошин Алексей", "Гилюн Денис", "Бондаренко Дмитрий", "Гриник Валентина", "Кучеренко Артем", "Михайлов Павло", "Рафалюк Роман", "Шенфельд Валентин", "Шуляк Борис", "Щербаков Антон"};
            for (int i = 0; i < 7; i++)
            {
